...
int main() {
    ...
    cout << "\nBuscando contacto con nombre " << nombreABuscar << ":" << endl;
    ...
    cout << "\nEliminando contacto con nombre " << nombreAEliminar << ":" << endl;
    ...
    cout << "\nLista de contactos despues de la eliminacion:" << endl;
    mostrarContactos(lista);

    // Contar contactos
    cout << "\nNumero de contactos en la lista: " << lista.getTamanio() << endl;
